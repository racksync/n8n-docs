...
[What Product People Need To Know About LangChain](https://www.commandbar.com/blog/langchain-guide){:target=_blank .external-link} สรุปคำศัพท์และ concepts พร้อมคำอุปมาอุปไมยที่เข้าใจง่าย เหมาะกับทุกกลุ่มผู้ใช้

ถ้าคุณชอบวิดีโอ [YouTube series by Greg Kamradt](https://youtu.be/_v_fgW2SkkQ?si=8Z2tfAoXnN3lXU9s){:target=_blank .external-link} นี้จะอธิบายเอกสาร LangChain พร้อมตัวอย่างโค้ด

n8n มีพื้นที่พูดคุยเกี่ยวกับ LangChain บน [Discord](https://discord.gg/bAt54txhHg){:target=_blank .external-link} เข้าร่วมเพื่อแชร์โปรเจกต์และพูดคุยกับ community
