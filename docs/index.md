...
# คู่มือ n8n ฉบับภาษาไทย


หากคุณคือผู้เริ่มใช้งาน n8n เว็บไซต์แห่งนี้จะช่วยให้คุณทำความเข้าใจและใช้งาน [n8n](https://n8n.io/){:target=_blank .external-link} (อ่านว่า เอ็น-เอท-เอ็น) อย่างเป็นระบบ ซึ่ง n8n เป็นเครื่องมือ workflow automation แบบ low code ที่ได้รับความนิยมมากในประเทศไทย ปัจจุบันได้รับ license แบบ [fair-code](https://faircode.io){:target=_blank .external-link} ที่นอกจากมีฟีเจอร์ที่หลากหลายแล้วยังมีการรวมความสามารถของ AI เข้ากับการทำงานอัตโนมัติของกระบวนการทางธุรกิจ โดยชื่อ n8n ย่อมาจาก nodemation ซึ่งเป็นชื่อที่ตั้งตามหลักการตั้งชื่อของโครงการโอเพนซอร์ส

เนื้อหาครอบคลุมทุกอย่างตั้งแต่การตั้งค่าไปจนถึงการใช้งานและการพัฒนา งานแปลชิ้นนี้ยังคงดำเนินการอยู่ และยินดีรับ [contributions](/help-community/contributing.md) จากสมาชิกใน community ทุกคน

## สิ่งที่คุณจะได้เรียนรู้

- การใช้งานพื้นฐานของ n8n
- การสร้าง workflows ที่ซับซ้อน
- การเชื่อมต่อกับ APIs ต่างๆ
- การใช้ฟีเจอร์ AI ใน n8n
- การสร้าง custom nodes
- การจัดการข้อมูลด้วยโค้ดเพียงเล็กน้อยหรือไม่ต้องใช้โค้ดเลย
- การใช้งาน n8n บน Cloud หรือ self-host
- สารพัด AI tools ที่ n8n รองรับ
...
## [แรคซิงค์ คือใคร?](/racksync.md)

[บริษัท แรคซิงค์ จำกัด หรือ RACKSYNC CO., LTD.](/racksync.md) เป็นบริษัทที่ปรึกษาและพัฒนาระบบซอฟต์แวร์ที่มีความเชี่ยวชาญในด้านการพัฒนาโซลูชันที่ใช้เทคโนโลยี Automation และ Infrastructure โดยมีเป้าหมายในการช่วยให้ธุรกิจสามารถใช้เทคโนโลยีเหล่านี้เพื่อเพิ่มประสิทธิภาพและสร้างมูลค่าให้กับองค์กร
...
หากคุณมีข้อสงสัยหรือคำถามเกี่ยวกับการใช้งาน n8n หรือการแปลเอกสาร สามารถติดต่อเราได้ที่
