...
title: เอกสารคู่มือ AWS Lambda node
description: เรียนรู้วิธีใช้ AWS Lambda node ใน n8n และดูเอกสารทางเทคนิคเพื่อเชื่อมต่อ AWS Lambda node เข้ากับ workflows ของคุณ
