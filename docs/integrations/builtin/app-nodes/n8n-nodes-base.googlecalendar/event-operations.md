...
title: การทำงานกับ Event ของ Google Calendar
description: เอกสารสำหรับการทำงานกับ Event ใน Google Calendar node ของ n8n แพลตฟอร์มอัตโนมัติเวิร์กโฟลว์ รวมถึงรายละเอียด operations การกำหนดค่า และลิงก์ไปยังตัวอย่างและข้อมูล credentials
