...
title: การทำงานกับ Folder ของ Google Drive
description: เอกสารสำหรับการทำงานกับ Folder ใน Google Drive node ของ n8n แพลตฟอร์มอัตโนมัติเวิร์กโฟลว์ รวมถึงรายละเอียด operations การกำหนดค่า และลิงก์ไปยังตัวอย่างและข้อมูล credentials
