...
title: คู่มือการใช้งาน Hugging Face Inference Model node
description: วิธีใช้ Hugging Face Inference Model node ใน n8n เพื่อเชื่อมต่อโมเดล Hugging Face กับ workflow
