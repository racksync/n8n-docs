...
description: เรียนรู้วิธีการใช้ Vector Store Question Answer Tool node ใน n8n อ่านเอกสารทางเทคนิคเพื่อรวม Vector Store Question Answer Tool node เข้ากับ workflow ของคุณ
