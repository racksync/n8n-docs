...
title: ทริกเกอร์ซับเวิร์กโฟลว์ (Execute Sub-workflow Trigger)
description: คู่มือ Execute Sub-workflow Trigger node สำหรับเริ่ม workflow จาก workflow อื่นใน n8n
