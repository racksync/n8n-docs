...
title: ข้อมูลยืนยันตัวตน OpenAI
description: เอกสารสำหรับข้อมูลยืนยันตัวตน OpenAI ใช้ข้อมูลนี้เพื่อยืนยันตัวตน OpenAI ใน n8n แพลตฟอร์ม workflow automation
