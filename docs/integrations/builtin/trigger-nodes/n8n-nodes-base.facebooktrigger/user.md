...
title: คู่มือ Facebook Trigger User object
description: เรียนรู้วิธีใช้ Facebook Trigger node กับ User object ใน n8n และวิธีเชื่อมต่อกับ workflow ของคุณ
...
ใช้ object นี้เพื่อรับการแจ้งเตือนเมื่อมีการเปลี่ยนแปลงโปรไฟล์ของผู้ใช้ ดูข้อมูลเพิ่มเติมเกี่ยวกับ trigger ได้ที่ [Facebook Trigger](/integrations/builtin/trigger-nodes/n8n-nodes-base.facebooktrigger/index.md)
...
ดูข้อมูลเพิ่มเติมได้ที่ [User](https://developers.facebook.com/docs/graph-api/webhooks/reference/user/){:target=_blank .external-link} ในเอกสารของ Meta
