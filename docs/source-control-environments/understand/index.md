...
title: ทำความเข้าใจ Source control และ Environments
description: ทำความเข้าใจการทำงานของ source control และ environments ใน n8n
...
* [Git in n8n](/source-control-environments/understand/git.md): วิธีที่ n8n ใช้ Git
